class Solution {
    fun romanToInt(numeroRomano: String): Int {
        ...
        while(i in numeroRomano!!.indices){
            ...
            if(atual < proximo){
                resultado = (proximo - atual) + resultado
                i++
...
fun main() {
    val numeroRomano: String = readLine().toString().filterNot { it == '\"'  }

    print(Solution().romanToInt(numeroRomano))
